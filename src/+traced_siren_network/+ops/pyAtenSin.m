...
% to generate MATLAB code corresponding to the aten::sin PyTorch
% operator.
%
...
%    Designer.
% 2) Look up the aten::sin PyTorch operator in the PyTorch
...
error(message('nnet_cnn_pytorchconverter:pytorchconverter:PlaceholderFunction', 'pyAtenSin'));
